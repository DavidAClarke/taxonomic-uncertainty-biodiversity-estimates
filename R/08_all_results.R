...
# Identity tests
id_tests <- list.files(here("data", "biodiversity", "output", "identity_tests"))
...
for(i in 1:length(id_tests)){
  ...
  get(load(here("data", "biodiversity", "output", 
                       "identity_tests", id_tests[i])))
...
species_2 <- c(hv_list[[2]]@Name,hv_list[[3]]@Name,hv_list[[4]]@Name,hv_list[[5]]@Name,hv_list[[6]]@Name, hv_list[[7]]@Name,
               hv_list[[3]]@Name, hv_list[[4]]@Name, hv_list[[5]]@Name,hv_list[[6]]@Name, hv_list[[7]]@Name, 
               hv_list[[4]]@Name, hv_list[[5]]@Name, hv_list[[6]]@Name, hv_list[[7]]@Name,
